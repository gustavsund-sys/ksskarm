...
I adminläget kan en inloggad administratör ladda upp en JPG-, PNG- eller WebP-bild och välja start/slut i svensk tid. En bild i taget kan schemaläggas; en ny ersätter den tidigare. Bilden fyller ytan under sidhuvudet utan beskärning och ersätter konserter, nedräkning och sidfot under perioden. Därefter återkommer ordinarie program automatiskt. Bilden anpassas till högst 2000 pixlar och 850 000 tecken JPEG-data och lagras i Firestore-dokumentet screenImages/program tillsammans med visningstiderna. Detta kräver inte Firebase Storage. Originalfilen får vara högst 20 MB. Undvik känsligt material: uppladdade bilder är offentligt läsbara tills de tas bort, även utanför visningsperioden.

Som alternativ kan en direkt HTTPS-länk till en offentlig bild schemaläggas. Länken kontrolleras som bild före sparning. Den externa servern måste tillåta att bilden visas på andra webbplatser. Om bilden inte kan laddas visas ordinarie konsertprogram och laddningen provas igen efter en minut.
